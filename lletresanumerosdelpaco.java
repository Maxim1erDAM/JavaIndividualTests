public class main2 {
    ...
    static String unidad(int numero){
    ...
    static String decena(int numero){
    ...
    static String centena(int numero){
        if (numero >= 100)
        {
    ...
    static String miles(int numero){
    ...
    static String decmiles(int numero){
        if (numero == 10000)
    ...
    static String cienmiles(int numero){
        if (numero == 100000)
    ...
    static String millon(int numero){
    ...
    static String decmillon(int numero){
        if (numero == 10000000)
    ...
    static String convertirLetras(int num){
        numero=num;
        genero =0;
    ...
    public static void main(String[] args) {
        System.out.println(convertirLetras(99999999));
    }
}
